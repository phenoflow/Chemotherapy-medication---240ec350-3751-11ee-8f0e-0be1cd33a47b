...
codes = [{"code":"11881","system":"prod"},{"code":"13116","system":"prod"},{"code":"14136","system":"prod"},{"code":"15790","system":"prod"},{"code":"18485","system":"prod"},{"code":"22332","system":"prod"},{"code":"24580","system":"prod"},{"code":"28797","system":"prod"},{"code":"38435","system":"prod"}];
REQUIRED_CODES = 1;
